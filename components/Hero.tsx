...
export default function Hero() {
  return (
    <section className="gradient-hero pt-32 pb-20 md:pt-40 md:pb-28 relative overflow-hidden data-grid">
      ...
      <div className="absolute top-20 left-1/4 w-96 h-96 bg-cobalt/10 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-goon-green/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "-3s" }} />
      <div className="absolute top-1/2 right-10 w-64 h-64 bg-cobalt/5 rounded-full blur-3xl animate-float" style={{ animationDelay: "-1.5s" }} />

      <div className="max-w-4xl mx-auto px-6 text-center relative">
        <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-cobalt/20 rounded-full px-4 py-1.5 mb-8">
          <span className="w-2 h-2 rounded-full bg-goon-green animate-pulse-soft" />
        ...
        <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.05] tracking-tight mb-6 text-white">
          ...
          <span className="bg-cobalt/10 px-3 py-1 rounded-xl inline-block" style={{ color: "#10B981", WebkitTextFillColor: "#10B981" }}>
            60 seconds
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/auth/signup"
            className="bg-cobalt text-white font-semibold px-8 py-4 rounded-xl text-lg hover:bg-cobalt/90 transition-colors"
          >
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="bg-goon-green/10 text-goon-green text-xs font-bold px-2 py-0.5 rounded-md">
                  BUY
                </span>
              </div>
            </div>
            <div className="text-right">
              ...
              <div className="text-2xl font-bold text-cobalt mt-1">78%</div>
            </div>
          </div>
          <div className="w-full bg-white/5 rounded-full h-2 mb-4">
            <div className="bg-cobalt h-2 rounded-full" style={{ width: "78%" }} />
          </div>
